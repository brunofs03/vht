...
$sql = "SELECT * FROM  quartos where num_quarto = " .$_POST['txtNum'];
...
if($idInserido == ''){
	...
	if ($uploadOk == 1) {
		    ...
		    $mensagemRetorno = "Quarto " . $_POST['txtNum'] . " cadastrado com sucesso!";
		 
	}else{
		$mensagemRetorno = "Ocorreu um erro ao realizar o cadastro\n\n".$mensagemRetorno;
	}
}else{
 	$mensagemRetorno = "Já existe um quarto com esse número!";
		$uploadOk = 0;
 }

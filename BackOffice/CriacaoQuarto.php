...
<!-- Seção dos gráficos -->
  ...
  <h1 style="text-align: center;background-color:white;margin: 0 !important;padding: 15px !important;font-size: 36px !important;border: 1px solid #d8d8d8;">Cadastro de quarto</h1>
  <br>
    ...
    <div class="col-sm-7">
      ...
      <div style="background-color:white;height:330px;width:100%;border:1px solid #ddd;padding:10px">
        ...
        <div class="row" style="margin:0">
          ...
          <div class="col-sm-3">
            <button type="button" onclick="cadastraQuarto()" style="width:100%;color: white;background-color: #292d33;" class="btn">Cadastrar</button>
          </div>
        </div>
    </div>
  </div>
...
<script>
 ...
 <script>
    ...
    function cadastraQuarto(){
        ...
        if(document.getElementById('ImportImgQuarto').value == ''){
          mensagem = mensagem + '\n- Imagem do quarto'
        }
